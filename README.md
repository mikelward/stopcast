...
Android **lock screen** and home screen, and in full in the app. StopCast reads
...
The product and architecture spec lives in [`SPEC.md`](./SPEC.md); the phased plan is
in [`TODO.md`](./TODO.md). Agent and contributor conventions are in
[`AGENTS.md`](./AGENTS.md).

StopCast is not affiliated with Transport for London. It uses the free TfL Unified API.
