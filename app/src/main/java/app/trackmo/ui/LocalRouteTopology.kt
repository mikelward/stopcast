 ...
 * way the widget does (see [app.trackmo.domain.DepartureRows.destinationLines]). Provided once
 * at the composition root ([app.trackmo.MainActivity]) from the bundled asset, warmed off the
