...
// Trackmo's brand accent is red — a nod to the London transit palette — applied the
...
/**
 * The app theme. Uses the trackmo red-accent scheme (light or dark by the system setting).
 *
