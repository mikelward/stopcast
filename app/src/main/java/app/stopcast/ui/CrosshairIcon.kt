 ...
 * in for one glyph — on a control that is temporary (a manual re-locate for on-device
 * radius testing) — isn't worth it. The path is Material's, tinted by `Icon` at the call
 * site like any core icon.
 */
