...
import app.stopcast.domain.FONT_SCALE_PINCH_SLOP_DP
import app.stopcast.domain.FontSizeSettings
import app.stopcast.domain.clampFontScale
import app.stopcast.domain.fontScaleAfterZoom
import app.stopcast.domain.pinchPassedSlop
 ...
 * a window boundary on its own. Null outside [app.stopcast.ui.theme.StopCastTheme].
 */
