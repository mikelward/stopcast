...
/**
 * Pins the brand: [TrackmoTheme]'s red `primary` in both themes, and that dynamic color is
    ...
    private fun primaryUnder(darkTheme: Boolean, dynamicColor: Boolean?): Color {
        ...
        composeRule.setContent {
            ...
            if (dynamicColor == null) {
                TrackmoTheme(darkTheme = darkTheme) { capture() }
            } else {
                TrackmoTheme(darkTheme = darkTheme, dynamicColor = dynamicColor) { capture() }
            }
        }
